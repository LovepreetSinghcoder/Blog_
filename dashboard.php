...
$stmt = $pdo->prepare("SELECT SUM(views) AS total_views FROM blogposts WHERE user_id = ?");
$stmt->execute([$user_id]);
  ...
  <div class="_container">
    <div class="_sidebarCont flex-shrink-0 p-3 text-white bg-dark">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="dashboard.php" class="nav-link active text-white" style="background-color: #6610f2">
            Dashboard
          </a>
        </li>
        <li>
    ...
    <div class="mainCont container mx-2 py-4 px-4">
      ...
      <h3>Total Views ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆</h3>
      <br>
      <div class="card" style="width: 18rem;">
        <div class="card-body">

          <h5 class="card-subtitle mb-2 text-muted"><?php echo "$total_views" ?></h5>

          <p class="text-muted">• Live data</p>
      ...
      <div class="card">
        ...
        <div class="card-body d-flex justify-content-between">
          <h5 class="card-title"><?php echo "{$top_post['title']}" ?></h5>
          <p class="card-text"><?php echo "{$top_post['views']}" ?></p>
